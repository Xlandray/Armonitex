...
export function LoginPage() {
  ...
  return (
    <main style={{ display: "grid", minHeight: "100vh", placeItems: "center", background: "#f8fafc" }}>
      <Card style={{ width: 400, borderRadius: 12, boxShadow: "0 4px 12px rgba(0,0,0,0.05)" }}>
        <div style={{ textAlign: "center", marginBottom: 24 }}>
          <div style={{ display: "inline-flex", gap: 4, borderRadius: 6, overflow: "hidden", marginBottom: 12 }}>
            <span style={{ background: "#961358", color: "#fff", padding: "6px 12px", fontWeight: "bold", fontSize: 14 }}>UPDATE</span>
            <span style={{ background: "#00A699", color: "#fff", padding: "6px 12px", fontWeight: "bold", fontSize: 14 }}>ARMONİTEX</span>
          </div>
