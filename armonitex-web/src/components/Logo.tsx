  ...
  return (
    <div className={`inline-flex items-center select-none ${className}`}>
      ...
      <div className="bg-brand-magenta-token text-white-token px-3 py-1.5 rounded-l-md flex flex-col justify-center items-start">
        <span className="font-display text-base font-black tracking-tight leading-none uppercase">UPDATE</span>
        <span className="font-mono text-[8px] font-medium text-on-brand-soft-token tracking-tight uppercase leading-tight mt-0.5">
          Açıkhava Çözümleri
        </span>
      </div>
      ...
      <div className="bg-brand-token text-white-token px-3.5 py-1.5 rounded-r-md flex flex-col justify-center items-start">
        <span className="font-display text-base font-black tracking-tight leading-none uppercase">ARMONİTEX</span>
        <span className="font-mono text-[8px] font-medium text-on-brand-soft-token tracking-tight uppercase leading-tight mt-0.5">
